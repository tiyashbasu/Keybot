...
// 
// added better pot handling and more sample rates, modded 4.15.12
//
// modded 8.14.12 - added clobbers to codec transfer routine
...
static inline void AudioCodec_init(void) {
  ...
  // the new Wire command gets confused with 0x00, so (uint8_t) is added
  Wire.begin();
